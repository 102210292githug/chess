...
<script type="text/javascript" src="<c:url value='/template/web/JS/Run.js'/>"></script>
<script type="text/javascript" src="<c:url value='/template/web/JS/Sources.js'/>"></script>
<script type="text/javascript" src="<c:url value='/template/web/JS/KhoiTao.js'/>"></script>
<script type="text/javascript" src="<c:url value='/template/web/JS/Function.js'/>"></script>
<script type="text/javascript" src="<c:url value='/template/web/JS/XacDinhDuongDi/Tot.js'/>"></script>
<script type="text/javascript" src="<c:url value='/template/web/JS/XacDinhDuongDi/Vua.js'/>"></script>
<script type="text/javascript" src="<c:url value='/template/web/JS/XacDinhDuongDi/Xe.js'/>"></script>
<script type="text/javascript" src="<c:url value='/template/web/JS/XacDinhDuongDi/Tuong.js'/>"></script>
<script type="text/javascript" src="<c:url value='/template/web/JS/XacDinhDuongDi/Ma.js'/>"></script>
<script type="text/javascript" src="<c:url value='/template/web/JS/XacDinhDuongDi/Hau.js'/>"></script>
		...
		<div id="mid">
			<div id="divNguoiChoiCoDen">
				<table id="tblNguoiCoDen">
					<tr>
						<td><img id="iCoDen" src="<c:url value='/template/web/User/User_Enb.png'/>" alt="" /></td>
			...
			<div id="divNguoiChoiCoDo">
				<table id="tblNguoiChoiCoDo">
					<tr>
						<td><img id="iCoDo" src="<c:url value='/template/web/User/User_Dis.png'/>" alt="" /></td>
		...
		<div id="right">
			<div id="edit-Right">
				<p class="inRight" id="playChess">
					PLAY CHESS <br></br> <i style="color: black;"
						class="fa-solid fa-chess"></i>
				</p>
				<button class="inRight" id="playOnl">
					<i class="fa-solid fa-bolt"></i>Play Online
				</button>
				<button class="inRight" id="computer">
